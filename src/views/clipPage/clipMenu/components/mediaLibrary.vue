  ...
  <div class="p-5">
    ...
    <div class="h-[calc(100vh-7rem)] mt-2 overflow-y-auto">
      <div class="w-full grid grid-cols-2 gap-3">
        <div
          class="relative flex flex-col justify-center w-full hover:bg-[#121212] p-1.5 rounded-md"
        ...
        >
          <div class="relative w-full h-full bg-[#121212]">
            <img
              :src="item.filePath"
              alt=""
              class="aspect-video object-contain rounded"
            ...
            >
              <el-icon
                class="w-full h-full bg-[#333333] rounded-full cursor-pointer"
